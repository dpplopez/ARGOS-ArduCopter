...
// == MODIFIED FOR ARGOS ==========================================================================
// This file and other files in ArduCopter source code include the modifications enumerated here
// for ARGOS integration.
//
// All modifications in source code are enclosed in comments containing "MODIFIED FOR ARGOS", just
// the same way as this comment is enclosed. This is done to make it easier to find and identify
// ARGOS related changes.
//
// Source code modifications:
//
// * ArduCopter.pde
//   - THISARGOSFW definition added with ARGOS specific name (used for logs and cli interface)
//   - Sonar object type changed to AP_RangeFinder_SRF08 for using SRF08 I2C sensor
// * system.pde
//   - Activate UART2 (UART B) for wireless telemetry (simultaneous wireless/USB telemetry)
// * AP_RangeFinder.h
//   - Added a reference to include AP_RangeFinder_SRF08.h for using the SRF08 I2C sonar
// * AP_RangeFinder_SRF08.cpp/h
//   - New class implementing the interface for using the SRF08 I2C sonar
//   - Sonar interface extended with getAddress() function to retreive I2C sensor address
//   - Added test code for measuring read time and for retrieving several echoes
// * test.pde
//   - Sonar test output extended to show I2C address, measured distance and health
//   - Sonar test output depends on sonar test code definitions (AP_RangeFinder_SRF08.h)
// ================================================================================================

// == MODIFIED FOR ARGOS ==========================================================================
// Firmware name used for logs and cli interface can't be changed from original "ArduCopter V3.0.1"
// If changed, Mission Planner does not recognize flash logs
#define THISARGOSFW "ARGOS-1.0 AC-3.0.1"
...
// == MODIFIED FOR ARGOS ==========================================================================
// Sonar used is SRF08 with I2C interface
//static AP_RangeFinder_MaxsonarXL *sonar;ç
static AP_RangeFinder_SRF08 *sonar;
// ================================================================================================
#endif
...
void setup() {
 ...
 #endif
// == MODIFIED FOR ARGOS ==========================================================================
// Using SRF08 I2C sonar
    // sonar = new AP_RangeFinder_MaxsonarXL(sonar_analog_source,
    //         &sonar_mode_filter);
    sonar = new AP_RangeFinder_SRF08(&sonar_mode_filter);
// ================================================================================================
#endif
