...
// == MODIFIED FOR ARGOS ==========================================================================
// Activating the second serial port for telemetry requires getting rid of USB_MUX_PIN conditional
// build. UART A and UART C are initialized, allowing for simultaneous USB and radio telemetry.
//#if USB_MUX_PIN > 0
    if (!ap_system.usb_connected) {
